...
#region Beatmaps
        ...
        public async UniTask<Beatmap?> BeatmapByHash(string hash, CancellationToken token = default, bool skipCacheCheck = false)
        {
        ...
        private async UniTask<Beatmap?> FetchBeatmap(string url, CancellationToken token = default)
        {
            ...
            if (searchOptions != null)
            {
                ...
                foreach (var property in _filterProperties)
                {
                    ...
                    if (filterValue != null)
                    {
                        ...
                        var encoded = WebUtility.UrlEncode(filterValue.ToString());
...
#region Users
        ...
        public async UniTask<User?> User(string name, CancellationToken token = default, bool skipCacheCheck = false)
        {
...
#region Voting
        ...
        /// <returns></returns>
        public async UniTask<VoteResponse> Vote(string levelHash, Vote.Type voteType, Vote.Platform platform, string platformID, string proof, CancellationToken token = default)
        {
...
#region Byte Fetching
        ...
        internal async UniTask<byte[]?> DownloadPreview(BeatmapVersion version, CancellationToken token = default, IProgress<double>? progress = null)
        {
