...
namespace BeatSaverSharp.Http
{
    internal class HttpClientService : IHttpService, IDisposable
    {
        ...
        public async UniTask<IHttpResponse> GetAsync(string url, CancellationToken token = default, IProgress<double>? progress = null)
        {
        ...
        public async UniTask<IHttpResponse> PostAsync(string url, object? body = null, CancellationToken token = default)
{
